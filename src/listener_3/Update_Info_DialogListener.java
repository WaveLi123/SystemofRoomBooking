				...
				try {					
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == bus.getkeyinfo_bus().length){
							...
							MainFrame_3.instance().closeUpdate_Info_Dialog();
							MainFrame_3.instance().openUpdateinfo_Bus(jtfNum.getText());	
						}
					}					
				...
				try {					
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == route.getkeyinfo().length){
							...
							MainFrame_3.instance().closeUpdate_Info_Dialog();
							MainFrame_3.instance().openUpdateinfo_Route(jtfNum.getText());	
						}
					}					
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {					
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeUpdate_Info_Dialog();
							MainFrame_3.instance().openUpdateinfo_Local(jtfNum.getText());	
						}
					}					
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {					
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeUpdate_Info_Dialog();
							MainFrame_3.instance().openUpdateinfo_LongDistance(jtfNum.getText());	
						}
					}
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {					
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeUpdate_Info_Dialog();
							MainFrame_3.instance().openUpdateinfo_Employee(jtfNum.getText());	
						}
					}				
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {					
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeUpdate_Info_Dialog();
							MainFrame_3.instance().openUpdateinfo_Manager(jtfNum.getText());	
						}
					}				
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {					
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeUpdate_Info_Dialog();
							MainFrame_3.instance().openUpdateinfo_Passenger(jtfNum.getText());	
						}
					}					
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {					
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == Bicycle.getkeyinfo().length){
							...
							MainFrame_3.instance().closeUpdate_Info_Dialog();
							MainFrame_3.instance().openUpdateinfo_Bicycle(jtfNum.getText());	
						}
					}					
				} catch (ClassNotFoundException e1) {
					e1.printStackTrace();
