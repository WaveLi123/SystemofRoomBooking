				...
				try {
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo_bus().length){
							...
							MainFrame_3.instance().closeDelete_Info_Dialog();				
							MainFrame_3.instance().openDeleteinfo_Bus(jtfNum.getText());	
						}						
					}				
				...
				try {
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeDelete_Info_Dialog();				
							MainFrame_3.instance().openDeleteinfo_Route(jtfNum.getText());	
						}						
					}				
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeDelete_Info_Dialog();				
							MainFrame_3.instance().openDeleteinfo_Local(jtfNum.getText());	
						}						
					}				
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeDelete_Info_Dialog();				
							MainFrame_3.instance().openDeleteinfo_LongDistance(jtfNum.getText());	
						}						
					}				
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeDelete_Info_Dialog();				
							MainFrame_3.instance().openDeleteinfo_Employee(jtfNum.getText());	
						}						
					}				
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeDelete_Info_Dialog();				
							MainFrame_3.instance().openDeleteinfo_Manager(jtfNum.getText());	
						}						
					}				
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeDelete_Info_Dialog();				
							MainFrame_3.instance().openDeleteinfo_Passenger(jtfNum.getText());	
						}						
					}				
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
				...
				try {
					if(jtfNum.getText().equalsIgnoreCase("")){
						...
						if(i == temp.getkeyinfo().length){
							...
							MainFrame_3.instance().closeDelete_Info_Dialog();				
							MainFrame_3.instance().openDeleteinfo_Bicycle(jtfNum.getText());	
						}						
					}				
				} catch (ClassNotFoundException e1) {
					// TODO Auto-generated catch block
